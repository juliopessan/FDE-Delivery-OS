...
| [`docs/`](docs) | Aprofundamentos: modelo de precificação, governança/segurança, stack de referência |
...
2. Ao iniciar um engajamento novo, copie os templates de `templates/` para a pasta do projeto do cliente.
3. Ao final de cada fase, rode o checklist correspondente em `checklists/` antes de avançar (Go/No-Go).
4. Use `docs/stack-referencia.md` como cardápio de ferramentas — adapte à realidade de infraestrutura de cada cliente.
