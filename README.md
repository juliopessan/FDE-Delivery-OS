...
| **2. Time de agentes (execução)** | O "quem" e o "como" — 9 agentes de IA, skills reutilizáveis, specs de tarefa e o harness operacional que roda tudo isso no Claude Code | [`.claude/agents/`](.claude/agents), [`.claude/skills/`](.claude/skills), [`specs/`](specs), [`harness/`](harness) |
