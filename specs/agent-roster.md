...
| [`fde-data-engineer`](../.claude/agents/fde-data-engineer.md) | 2 (Especialista) | Integração Microsoft Fabric, OneLake, pipelines de dados legados | Read, Write, Edit, Bash, WebSearch | Fase 2 complexa (Enterprise/Fabric) | `fde-context-engineer` / `fde-architect` |
...
| [`fde-ai-model-specialist`](../.claude/agents/fde-ai-model-specialist.md) | 3 (Especialista) | Benchmark de modelos (LLM vs SLM), custo de tokens, latência | Read, Write, Edit, WebSearch, Agent | Decisão de modelo na Fase 3 | `fde-architect` |
