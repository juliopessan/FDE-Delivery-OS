...
1. **Nunca cobrar por hora nas Fases 1-3.** Hora incentiva lentidão; fixed-fee incentiva eficiência e protege a margem do FDE solo.
2. **Reprecificar a cada transição de fase**, nunca no meio de uma fase em andamento.
